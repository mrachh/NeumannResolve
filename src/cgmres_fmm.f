...
c
c
        subroutine cgmres_fmm(ier,n,multa,zk,ifdn,ifinout,
...
c
        ...
        lzr=n
c
        call cgmres_fmm1(ier,n,multa,zk,ifdn,ifinout,
...
c
c
        subroutine cgmres_fmm1(ier,n,multa,zk,ifdn,ifinout,xys,
...
c
        call multa(zk,x,z,n,ifdn,ifinout,xys,dxys,qwts,nedges,ncint,
...
c
        call multa(zk,z,w,n,ifdn,ifinout,xys,dxys,qwts,nedges,ncint,
     1    lns,rns,icl,icr,icsgnl,icsgnr,xsgnl,xsgnr,ncorner,xmatc,
     2    xmatcsub)
c
