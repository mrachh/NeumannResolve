...
c
c
        subroutine dgmres_blas(ier,n,a,multa,ift,y,eps,numit,
     1     x,niter,errs,ngmrec,w)
        implicit real *8 (a-h,o-z)
        dimension errs(1)
        real *8 a(n,n),x(1),y(1),w(1)
c
        external multa
c
...
c
        ...
        lzr=n
c
        call dgmres_blas1(ier,n,a,multa,ift,y,eps,numit,x,niter,errs,
...
c
c
        subroutine dgmres_blas1(ier,n,a,multa,ift,y,eps,numit,
     1     x,niter,errs,ngmrec,e,ae,z,w,xr,zr)
        implicit real *8 (a-h,o-z)
c
        dimension errs(1)
        real *8 a(n,n),x(1),y(1),e(n,1),ae(n,1),
