...
figure(2)
clf()
plot(arclength,rhs,'k.',label='rhs real part',markersize=5)
legend()

figure(3)
semilogy(arclength,abs(soln),'b.',label='soln real part',markersize=5)
legend()
show()
