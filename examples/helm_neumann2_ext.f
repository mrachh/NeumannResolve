...
c
      ...
      do iedge=1,nedges
        ...
        do ipt = 1,nepts_ref(iedge)
          ...
          call getrhs(zk,ncharges,xsrc_in,ysrc_in,charges,
     1      xs_ref(i),ys_ref(i),pot,grad)
          rhs_ref(i) = sqrt(qwts_ref(i))*(grad(1)*rnxe(iedge)+
     1       grad(2)*rnye(iedge))

          call getrhs(zk,ncharges,xsrc_ext,ysrc_ext,charges,xs_ref(i),
     1       ys_ref(i),pot,grad)
     ...
     1       grad(2)*rnye(iedge))
          ...
          call getrhs(zk,ncharges,xsrc_ext,ysrc_ext,charges,xs(i),
     1       ys(i),pot,grad)
...
c
      ...
      call getrhs(zk,ncharges,xsrc_in,ysrc_in,charges,trg(1),trg(2),
     1    potex_1,gradex)
...
c
      do i=1,ntarg
        call getrhs(zk,ncharges,xsrc_in,ysrc_in,charges,xt(i),
     1    yt(i),potex(i),grad)
      enddo
